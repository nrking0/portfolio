...
const activities = [
    ...
    },
    {
        ...
        "description": 'For Spring semester 2021, I was selected to be a project manager for the honors section of introduction to computer science (CS 196). I am managing a small project group to build a full stack application that analyzes stock data. Additionally, I help out with the course by running office hours and helping students.'
    },
    {
        "type": "Work",
                        ...
                        {activities.map((activity) => (
                            <>
                                {activity.type === "Courses" ? (
                                    ...
                                    <Accordion>
                                        <MuiAccordionSummary expandIcon={<MdExpandMore />}>{activity.title}</MuiAccordionSummary>
                                        <AccordionDetails style={{ display: 'flex', flexDirection: 'column' }}>
                                            <h4>{activity.role}<br />{activity.date}</h4>
