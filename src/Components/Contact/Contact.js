    ...
    return( 
        <Element id="Contact">
            ...
            <div className = "buttons">
                ...
                <Button href="https://drive.google.com/file/d/1h-_Cyr-2XN5fG3cLumn2LnZv29spkaSb/view?usp=sharing" target="_blank" variant="contained" color="secondary" className={classes.button} startIcon={<DescriptionIcon />} onClick={()=> ReactGA.event({category: "Information", action: "Viewed Resume", label: "Resume Contact Section"})}>Resume</Button>
            </div> 
                </Fade>
        </Element>
    )
